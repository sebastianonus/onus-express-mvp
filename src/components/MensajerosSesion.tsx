...
export function MensajerosSesion() {
  ...
  useEffect(() => {
    /**
     * PLACEHOLDER: Verificación de autenticación
     * 
     * INTEGRACIÓN FUTURA:
     * - Verificar sesión con Supabase Auth
     * - Cargar campañas desde /api/campaigns
     * - Cargar postulaciones desde /api/postulaciones
     * 
     * ESTADO ACTUAL: Sin autenticación real
     * - No redirige (el componente renderiza libremente)
     * - No carga datos
     */
    ...
    // INFO: Este componente requiere Supabase Auth para funcionar
    console.info('MensajerosSesion: Pendiente de integración con Supabase Auth');
  }, [navigate]);
  ...
  const handleBuscarCampanas = () => {
     ...
     * 
     * INTEGRACIÓN FUTURA:
     * - POST a /api/campaigns/search con filtros
    ...
    // Actualizar mensajero localmente (solo UI)
    if (mensajero) {
      setMensajero({
        ...mensajero,
    ...
    // Placeholder: No hay campañas hasta que se conecte backend
    setCampanasFiltradas([]);
    setShowFilters(false);
    
    toast.info('Función de búsqueda pendiente de integración con backend');
  };
          ...
          >
            <div className="p-6 sm:p-8">
              ...
              <form onSubmit={(e) => {
                 ...
                 * 
                 * INTEGRACIÓN FUTURA:
                 * - POST a /api/postulaciones con datos del formulario
                 * - Actualizar estado local tras confirmación del servidor
                 */
                
                // Placeholder: Mostrar que la función no está conectada
                toast.info('Función de postulación pendiente de integración con backend');
