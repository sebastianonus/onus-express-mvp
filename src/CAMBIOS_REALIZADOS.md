...
- Se protegi� el panel admin moviendolo a `/admin/panel` con validacion de sesion local.
...
- Se aplico el nuevo dise�o visual solicitado para el formulario de PIN.
